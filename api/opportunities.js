  ...
  try {
    ...
    if (event.httpMethod === 'PUT') {
      ...
      const [opp] = await sql`UPDATE opportunities SET
        ...
        value=CASE WHEN ${b.value !== undefined && b.value !== '' ? 1 : 0}=1 THEN ${b.value !== undefined && b.value !== '' ? Number(b.value) : null} ELSE value END,
        probability=CASE WHEN ${b.probability !== undefined && b.probability !== '' ? 1 : 0}=1 THEN ${b.probability !== undefined && b.probability !== '' ? Number(b.probability) : null} ELSE probability END,
