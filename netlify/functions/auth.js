...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (action === 'register') {
      ...
      // Notify admin about new registration (if webhook configured)
    ...
    // Admin actions: list pending users, approve, reject
    if (action === 'list_pending' || action === 'approve_user' || action === 'reject_user') {
