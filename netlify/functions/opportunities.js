...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (event.httpMethod === 'POST') {
      ...
      const [opp] = await sql`INSERT INTO opportunities (title, contact_id, contact_ids, company_id, stage, value, probability, priority, next_action, next_action_date, expected_close_date, tech_tags, atos_sales_id, atos_delivery_id, user_id) VALUES (${b.title}, ${b.contactId||null}, ${JSON.stringify(b.contactIds||[])}, ${b.companyId||null}, ${b.stage||'lead'}, ${b.value||0}, ${b.probability||20}, ${b.priority||'medium'}, ${b.nextAction||''}, ${b.nextActionDate||null}, ${b.expectedCloseDate||null}, ${JSON.stringify(b.techTags||[])}, ${b.atosSalesId||null}, ${b.atosDeliveryId||null}, ${user.id}) RETURNING *`;
    ...
    if (event.httpMethod === 'PUT') {
      ...
      const [opp] = await sql`UPDATE opportunities SET
        ...
        contact_id=${b.contactId!==undefined?b.contactId||null:null},
        contact_ids=COALESCE(${b.contactIds?JSON.stringify(b.contactIds):null},contact_ids),
        company_id=${b.companyId!==undefined?b.companyId||null:null},
        ...
        next_action=COALESCE(${b.nextAction},next_action),
        next_action_date=${b.nextActionDate||null},
        expected_close_date=${b.expectedCloseDate||null},
        tech_tags=COALESCE(${b.techTags?JSON.stringify(b.techTags):null},tech_tags),
        atos_sales_id=${b.atosSalesId||null},
        atos_delivery_id=${b.atosDeliveryId||null},
