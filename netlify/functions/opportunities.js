  ...
  try {
    ...
    if (event.httpMethod === 'PUT') {
      ...
      const [opp] = await sql`UPDATE opportunities SET
        ...
        value=CASE WHEN ${b.value !== undefined && b.value !== '' ? 1 : 0}=1 THEN ${Number(b.value)} ELSE value END,
        probability=CASE WHEN ${b.probability !== undefined && b.probability !== '' ? 1 : 0}=1 THEN ${Number(b.probability)} ELSE probability END,
